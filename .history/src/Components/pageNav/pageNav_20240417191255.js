...
export function PageNav(props){
    ...
    function PrevPageButton(){
        if (prevPage){
            return <Link to={path.replaceAll(`page=${currentPage}`,`page=${prevPage}`)}><i class="fa-solid fa-arrow-left"></i></Link>
        }
    }
    function NextPageButton(){
        if (nextPage){
            return <Link to={path.replaceAll(`page=${currentPage}`,`page=${nextPage}`)}><i class="fa-solid fa-arrow-right"></i></Link>
        }
    }
