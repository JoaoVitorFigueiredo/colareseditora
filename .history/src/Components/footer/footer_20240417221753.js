            ...
            <footer className="footer">
                ...
                <div className="footer-section">
                    ...
                    <ul className="footer-list">
                        ...
                        <li className="footer-list-item"><Link to="/link2" className="footer-link">Carrinho</Link></li>
                        <li className="footer-list-item"><Link to="/link3" className="footer-link">Loja</Link></li>
                    </ul>
                </div>
            </div>
